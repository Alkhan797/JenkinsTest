...
// à partir d'une DLL. Tous les fichiers contenus dans cette DLL sont compilés avec le symbole ROOTFINDER_EXPORTS
...
// Cette classe est exportée de RootFinder.dll
